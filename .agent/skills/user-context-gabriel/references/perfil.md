...
- **Linguagens:** PHP, Python, C#, JavaScript (ES6+), HTML5, CSS3
- **Frameworks/Bibliotecas:** Bootstrap, .NET, MadBuilder (PHP), Flutter/Dart
- **Mobile:** Flutter, FlutterFlow

### Infraestrutura e Segurança
- **Servidores:** Linux (Apache), Windows Server 2016 (AD, Group Policy)
- **Redes:** Suporte técnico avançado, troubleshooting, Cisco CCNA
- **Segurança:** Google Cybersecurity Professional, conformidade LGPD, mitigação de riscos
